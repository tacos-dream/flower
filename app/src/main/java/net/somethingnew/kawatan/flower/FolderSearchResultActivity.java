...
public class FolderSearchResultActivity extends AppCompatActivity {
    ...
    public void buildRecyclerView() {
        ...
        mRecyclerViewAdapter = new FolderListRecyclerViewAdapter(globalMgr.mSearchedFolderLinkedList);
        ...
        mRecyclerViewAdapter.setOnItemClickListener(new FolderListRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                globalMgr.mCurrentFolderIndex = getCurrentFolderIndex(globalMgr.mSearchedFolderLinkedList.get(position).getId());
                if (globalMgr.mCurrentFolderIndex == -1) {
                    return;
                }
    ...
    private int getCurrentFolderIndex(String folderId) {
        for (int index = 0; index < globalMgr.mFolderLinkedList.size(); index++) {
            if (globalMgr.mFolderLinkedList.get(index).getId().equals(folderId)) {
                return index;
            }
        }
        return -1;
