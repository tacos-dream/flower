...
public class FirstTimeManualDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.dialog_first_time_manual, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        LogUtility.d("FolderListHelpDialog: W" + dialogWidth + " x H" + dialogHeight);
    }
