...
public class CardListHelpDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.dialog_card_list_help, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        LogUtility.d("CardListHelpDialogFragment: W" + dialogWidth + " x H" + dialogHeight);
    }
